...
const Dashboard = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      if (status === 'PENDING') {
        setRooms([]);
        setPendingRequests([]);
        toast.error("Votre demande est encore en attente d'approbation.");
        return;
      }
      ...
      if (status === 'REJECTED') {
        setRooms([]);
        setPendingRequests([]);
        toast.error("Votre demande d'accès a été refusée.");
        return;
      }
  ...
  if (userStatus === 'PENDING') {
    return (
      <div className="dashboard-container">
        ...
        <div className="register-card" style={{ maxWidth: '600px', margin: '80px auto', textAlign: 'center' }}>
          <h2>Demande en attente</h2>
          <p>
            Votre demande pour rejoindre cette maison a bien été envoyée.
            Vous devez attendre l'approbation du propriétaire avant d'accéder au tableau de bord.
          </p>
    ...
    return (
      <div className="dashboard-container">
        ...
        <div className="register-card" style={{ maxWidth: '600px', margin: '80px auto', textAlign: 'center' }}>
          ...
          <p>
            Votre demande d'accès à cette maison a été refusée.
            Vous ne pouvez pas accéder au tableau de bord.
          </p>
  ...
  return (
    ...
    {userRole === 'OWNER' && showInviteOptions && (
    ...
    {userRole === 'OWNER' && showAddRoomModal && (
    ...
    {userRole === 'OWNER' && addingDeviceRoomIdx !== null && (
    ...
    {filteredRooms.map((room) => {
      ...
      return (
        ...
        {userRole === 'OWNER' && confirmDeleteIdx === realIdx && !isMainDoor && (
          <div
          style={{
            background: '#fef2f2',
            padding: '10px',
